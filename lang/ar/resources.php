...
return [
    'user' => [
        ...
        'customers_label' => 'زبون',
        'customers_plural_label' => 'الزبائن',
        'customers_navigation_label' => 'الزبائن',
        'customers_title' => 'إدارة الزبائن',
        'management_label' => 'إداري',
        'management_plural_label' => 'الإدارة',
        'management_navigation_label' => 'الإدارة',
        'management_title' => 'إدارة الإدارة',
        ...
        'password_helper' => '9 أحرف على الأقل، بالأحرف اللاتينية حصراً، وتتضمن حرفاً كبيراً واحداً على الأقل (A-Z) ورقماً واحداً على الأقل.',
        'password_latin_only' => 'يجب أن تتكوّن كلمة المرور من أحرف لاتينية وأرقام ورموز فقط — لا تُقبل الأحرف العربية أو أي لغة أخرى.',
        'password_uppercase' => 'يجب أن تحتوي كلمة المرور على حرف كبير واحد على الأقل (A-Z).',
    ...
    'appointment' => [
        ...
        'slot_booked'               => 'محجوز',
        'slot_timeoff'              => 'إجازة',
        'slot_outside'              => 'خارج ساعات العمل',
        'booked_slot'               => 'موعد محجوز',
        'timeoff_slot'              => 'وقت إجازة',
        'select_service_date_first' => 'اختر خدمة وتاريخاً أولاً',
    ...
    'service' => [
        ...
        'tax_breakdown_hint' => 'أدخل السعر النهائي (شامل الضريبة) ليظهر التفصيل',
        'tax_breakdown_title' => 'تفصيل الضريبة',
        'tax_net' => 'قبل الضريبة',
        'tax_amount_label' => 'الضريبة',
        'tax_final' => 'السعر النهائي',
        'minutes' => 'دقيقة',
    ...
    'provider_attendance' => [
        'label' => 'سجل دوام',
        'plural_label' => 'سجلات الدوام',
        'navigation_label' => 'سجلات الدوام',
        'title' => 'دوام مقدّمي الخدمة',
        'section_info' => 'سجل الدوام',
        'provider' => 'مقدّم الخدمة',
        'work_date' => 'تاريخ اليوم',
        'check_in_at' => 'الحضور',
        'check_out_at' => 'الانصراف',
        'check_out_hint' => 'اتركه فارغًا إذا كانت الجلسة لا تزال مفتوحة (بلا انصراف).',
        'duration' => 'المدة',
        'branch' => 'الفرع',
        'source' => 'المصدر',
        'notes' => 'ملاحظات',
        'still_open' => 'مفتوحة',
        'open_sessions' => 'حالة الجلسة',
        'open_only' => 'المفتوحة فقط',
        'closed_only' => 'المغلقة فقط',
        'from' => 'من',
        'until' => 'إلى',
        'this_month' => 'هذا الشهر',
        'no_records' => 'لا توجد سجلات دوام بعد',
    ],
    ...
    // ─────────────────────────────────────────────────────────────
    // Color (قاموس الألوان / منتجات الصبغ)
    // ─────────────────────────────────────────────────────────────
    'color' => [
        'label'               => 'لون',
        'plural'              => 'الألوان',
        'navigation_label'    => 'الألوان',

        // Section
        'section_info'        => 'معلومات اللون',
        ...
        'stock_quantity_hint' => 'كمية مرجعية فقط — لا يتم تتبعها كمخزون فعلي',
        'is_active'           => 'نشط',
        'created_at'          => 'تاريخ الإنشاء',
